...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'A Programming Interface for Pixelated Studios'
  spec.description = 'This Gem provides simple ways to do semi-complex to complex things things in Ruby'
